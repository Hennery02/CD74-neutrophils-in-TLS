...
plot_data <- read.csv("cluster_2_dot_plot_data.csv", header = TRUE)

custom_order_cell_type <- c("SubType_1",
                  "SubType_2",
                  "SubType_3",
                  "SubType_4",
                  "SubType_5",
...
ggsave("cluster_2_dot_plot.pdf", plot = p_scrna_odds_ratio, width = 5, height = 3)
