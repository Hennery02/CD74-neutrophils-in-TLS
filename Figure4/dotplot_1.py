...
plot_data = pd.read_csv("dotplot_marker3gene_cluster1_scaled_plot_data.csv", index_col=0)
...
adata.obs['cluster_1'] = pd.Categorical(obs_cell_type, categories=cell_types)

ov.pl.dotplot(
    adata, marker_genes, groupby='cluster_1', cmap='RdBu_r', standard_scale='var', show=False,
)
plt.savefig('dotplot_marker3gene_cluster1_scaled.pdf', dpi=300, bbox_inches='tight')
