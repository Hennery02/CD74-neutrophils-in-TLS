...
df = pd.read_csv('distance_2_plot_data.csv')
n_cores = pd.read_csv('distance_2_n_cores.csv').set_index('TLS_group')['n_cores'].to_dict()
...
plt.tight_layout()
plt.savefig('distance_2.pdf', bbox_inches='tight')
